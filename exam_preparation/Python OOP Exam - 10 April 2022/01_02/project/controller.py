class Controller:
    ...
    def __found_player_by_name(self, name):
        return next(filter(lambda x: x.name == name, self.players), None)

    def __find_supply_by_type(self, type_of_supply):
        found_supply = None
        index = None
    ...
    def sustain(self, player_name: str, sustenance_type: str):
        player = self.__found_player_by_name(player_name)
    ...
    def duel(self, first_player_name: str, second_player_name: str):
        first_player = self.__found_player_by_name(first_player_name)
        second_player = self.__found_player_by_name(second_player_name)
