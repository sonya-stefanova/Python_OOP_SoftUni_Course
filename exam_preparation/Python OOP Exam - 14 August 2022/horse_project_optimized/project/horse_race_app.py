...
class HorseRaceApp:
    ...
    def add_horse_to_jockey(self, jockey_name: str, horse_type: str):
        ...
        found_horse = [h for h in self.horses if h.__class__.__name__ == horse_type and not h.is_taken]
        if not found_horse:
    ...
    def start_horse_race(self, race_type: str):
        ...
        fastest_jockey = sorted(race.jockeys, key=lambda j: -j.horse.speed)[0]
