...
class SpaceStation:
    ...
    def retire_astronaut(self, name: str):
        astronaut_to_be_retired = self.__find_astronaut_name(name)
        if not astronaut_to_be_retired:
            raise Exception(f"Astronaut {name} doesn't exist!")

        self.astronaut_repository.remove(astronaut_to_be_retired)
    ...
    def send_on_mission(self, planet_name: str):
        ...
        astronauts = [a for a in sorted(self.astronaut_repository.astronauts, key=lambda a: -a.oxygen)]
