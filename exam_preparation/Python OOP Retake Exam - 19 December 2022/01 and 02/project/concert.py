class Concert:
    ...
    CONCERT_TYPES = {"Metal", "Rock", "Jazz"}

    def __init__(self, genre: str, audience: int, ticket_price: float, expenses: float, place: str):
        self.genre = genre      #represents the genre of the concert.
        self.audience = audience   #number of people that will attend the concert.
        self.ticket_price = ticket_price #price of ONE ticket.
        self.expenses = expenses  #price for all expenses for the concert
        self.place = place      #place where the concert will be performed.
